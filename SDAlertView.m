...
#define LXADTitleFont       [UIFont boldSystemFontOfSize:20];
...
//            _cancelBtn.backgroundColor=SFQLightGrayColor;
...
-(void) setCancelColor:(UIColor *)cancelColor
{
    ...
    if (cancelColor) {
        ...
        [_cancelBtn setBackgroundImage:[UIImage imageWithColor:cancelColor] forState:UIControlStateNormal];
    }
}
...
-(void) setOtherColor:(UIColor *)otherColor
{
    if (otherColor) {
        ...
        [_otherBtn setBackgroundImage:[UIImage imageWithColor:otherColor] forState:UIControlStateNormal];
    }
}
...
-(void)btnClick:(UIButton *)btn{
    ...
    if (self.clickBlock) {
        self.clickBlock(btn.tag,btn.currentTitle);
    }
...
-(void)setAnimationStyle:(SDShowAnimationStyle)animationStyle{
...
@implementation UIImage (colorfuls)
